...
const CardAbout: React.FC<CardAboutProps> = ({
  ...
  return (
    <div className={`flex bg-white md:w-[450px] md:h-[250px] lg:w-[270px] lg:h-[400px] rounded-t-full rounded-b-full mx-[60px] md:mx-0 my-[20px] lg:my-10 lg:rounded-full shadow justify-center items-center`}>

                                ...
                                <div className='absolute z-10 mt-2 w-full h-[115px] bg-white border-2 border-[var(--navy)] rounded-lg shadow-lg'>
                                    <div className='text-center mt-3'>
                                        <div className='py-1 hover:bg-[linear-gradient(90deg,_var(--yellow)_0%,_white_100%)] mb-1'>
                                            <Link onClick={toggleDropdown} href="/profile" className=' cursor-pointer text-[20px] text-[var(--navy)] font-medium no-underline'>การตั้งค่า</Link>
                                        </div>
                                        <div className='py-1 hover:bg-[linear-gradient(90deg,_var(--red)_0%,_white_100%)] mb-1'>
                                            <button onClick={handleSignOut} className='cursor-pointer text-[20px] text-[var(--navy)] font-medium'>ออกจากระบบ</button>
                                        </div>
                                    </div>
                                </div>
                            )}

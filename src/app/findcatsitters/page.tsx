                    ...
                    <div>
                            ...
                            <div className="md:w-[400px] lg:w-[600px] h-[480px] shadow-xl bg-white rounded-[20px] mx-auto mb-5">
                                ...
                                <div className='p-7'>
                                    ...
                                    <div className=''>
                                        ...
                                        <div className='flex h-[35px] my-2'>
                                            <LiaHandPointRight className="text-[var(--blue)] w-[35px] h-[35px]" />
                                            <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2 w-[200px] md:w-full'>ค่าตอบแทนตามผลงาน<br />(ยิ่งทำงานได้ดีมากเท่าไร ยิ่งได้รับค่าตอบแทนสูง)</p>
                                        </div>
                                ...
                                <div className='p-7'>
                                    ...
                                    <div className=''>
                                        ...
                                        <div className='flex h-[35px] mt-2'>
                                            <LiaHandPointRight className="text-[var(--blue)] w-[35px] h-[35px]" />
                                            <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2 w-[200px] md:w-full'>ไม่มีประวัติอาชญากรรม<br />(ไม่มีข้อยกเว้นรวมถึงการพนัน ฯลฯ)</p>
                                        </div>
                                        <div className='flex h-[35px] my-[60px] md:my-9'>
                                            <LiaHandPointRight className="text-[var(--blue)] w-[35px] h-[35px]" />
                                            <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2 w-[200px] md:w-full'>สามารถเดินทางไปตามสถานที่ต่าง ๆ ที่กรุงเทพ นนทบุรี หรือ สมุทรปราการ (ภายในรัศมี 10 กม. จากบ้านคุณ)</p>
                                        </div>
                                        ...
                                        <div className='flex h-[35px] my-2'>
                                            <LiaHandPointRight className="text-[var(--blue)] w-[35px] h-[35px]" />
                                            <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2 w-[200px] md:w-[280px] lg:w-full'>สามารถทำงานได้มากกว่า 20 ชั่วโมงต่อสัปดาห์</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="md:w-[400px] lg:w-full h-[750px] md:h-[720px] lg:h-[570px] shadow-xl bg-white rounded-[20px] mx-auto">
                            ...
                            <div className='w-10/12 md:w-3/4 lg:w-1/2 mx-auto py-7'>
                                ...
                                <p className='text-[var(--navy)] text-[20px] font-semibold text-center'>กรุณาส่งข้อมูลต่อไปนี้ทาง LINE: @KitCat</p>
                                <div className=''>
                                    <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2'>1. ชื่อและนามสกุล</p>
                                    <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2'>2. เบอร์โทร</p>
                                    <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2'>3. ที่อยู่ปัจจุบันของคุณ</p>
                                    <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2'>4. ประสบการณ์การเลี้ยงแมว (กี่ปี แมวกี่ตัว)</p>
                                    <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2'>5. จำนวนชั่วโมงต่อสัปดาห์ที่คุณต้องการทำงานนี้</p>
                                    <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2'>6. วันในสัปดาห์ที่คุณต้องการทำงาน (เช่น วันหยุด วันธรรมดา ทุกวัน)</p>
                                    <p className='text-[18px] lg:text-[20px] font-medium ml-2 text-[var(--navy)] mt-2'>7. ยืนยันว่าคุณไม่มีประวัติอาชญากรรมใด ๆ</p>
                                </div>
